...
async def pm_next_page(bot, query):
    ...
    btn.insert(0, [InlineKeyboardButton("🔽 ᴄʟɪᴄᴋ ʙᴇʟᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ 🔽", url=f"https://t.me/+9NDSx_RIau")])
...
async def pm_AutoFilter(client, msg, pmspoll=False):    
    ...
    btn.insert(0, [InlineKeyboardButton("🔽 ᴄʟɪᴄᴋ ʙᴇʟᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ 🔽", url=f"https://t.me/+9NDSx_RI")])
    if offset != "":
        key = f"{message.id}"
